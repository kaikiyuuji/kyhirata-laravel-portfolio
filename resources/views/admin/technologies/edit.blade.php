    ...
    <div class="admin-card bg-white rounded-2xl p-5 sm:p-7">
        <form action="{{ route('admin.technologies.update', $technology->id) }}" method="POST">
            ...
            <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 border-t border-slate-100 pt-5 mt-6">
                <a href="{{ route('admin.technologies.index') }}" class="px-5 py-2.5 text-sm text-slate-600 hover:text-slate-900 text-center rounded-xl hover:bg-slate-100 transition">Cancelar</a>
